# PixelAPI — Official PHP SDK

Official PHP SDK for [PixelAPI](https://pixelapi.dev) — *AI image, video, audio, and 3D API for builders.*
...
```bash
composer require pixelapi/pixelapi-php
```
